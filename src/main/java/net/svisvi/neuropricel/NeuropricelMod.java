...
@Mod("neuropricel")
public class NeuropricelMod {
	public static final Logger LOGGER = LogManager.getLogger(NeuropricelMod.class);
	public static final String MODID = "neuropricel";

	public NeuropricelMod() {
